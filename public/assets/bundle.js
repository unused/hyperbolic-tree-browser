...
/* harmony default export */ __webpack_exports__["a"] = (HyperTreeCoordE);
...
/* harmony default export */ __webpack_exports__["a"] = (HyperTreeCoordS);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hypertree_coord_s__ = __webpack_require__(2);
...
class HyperTreeDrawNode {
  constructor(node, model) {
    ...
    this.ze = new __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_e__["a" /* default */](node.coordinates);
    this.zr = new __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_e__["a" /* default */](node.radiusCoordinates);

    this._ze = new __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_e__["a" /* default */](this.ze);
    this._zr = new __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_e__["a" /* default */](this.zr);

    this.zs = new __WEBPACK_IMPORTED_MODULE_1__hypertree_coord_s__["a" /* default */]();
  }
...
/* harmony default export */ __webpack_exports__["a"] = (HyperTreeDrawNode);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_e_js__ = __webpack_require__(1);
...
class HyperTreeNode {
  constructor(node, model) {
    ...
    this.node.z  = new __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_e_js__["a" /* default */]();
    this.node.zr = new __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_e_js__["a" /* default */]();
  }
...
/* harmony default export */ __webpack_exports__["a"] = (HyperTreeNode);
...
class RadialTreeBrowser {
  ...
  _init() {
    this.svg   = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this.selector);
  ...
  dragHandler() {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_d3__["drag"]()
      .on('start', () => {
        this.view.actions.startDrag(__WEBPACK_IMPORTED_MODULE_0_d3__["event"]);
        __WEBPACK_IMPORTED_MODULE_0_d3__["event"].sourceEvent.stopPropagation();
      })
      .on('drag', () => {
        this.view.actions.onDrag(__WEBPACK_IMPORTED_MODULE_0_d3__["event"]);
        __WEBPACK_IMPORTED_MODULE_0_d3__["event"].sourceEvent.stopPropagation();
        this.update();
      })
      .on('end', function() {
        if (testDoubleClick()) {
          this.clickHandler(__WEBPACK_IMPORTED_MODULE_0_d3__["event"]);
          return ;
        } else {
          this.view.actions.endDrag(__WEBPACK_IMPORTED_MODULE_0_d3__["event"]);
          __WEBPACK_IMPORTED_MODULE_0_d3__["event"].sourceEvent.stopPropagation();
          this.update();
        }

        __WEBPACK_IMPORTED_MODULE_0_d3__["event"].sourceEvent
...
/* harmony default export */ __webpack_exports__["a"] = (RadialTreeBrowser);
...
class HyperTree {
  constructor(root) {
    this.root  = root;
    this.model = new __WEBPACK_IMPORTED_MODULE_0__hypertree_model__["a" /* default */](this.root);
  }
  ...
  get view() {
    return new __WEBPACK_IMPORTED_MODULE_1__hypertree_view__["a" /* default */](this.model);
  }
}

/* harmony default export */ __webpack_exports__["a"] = (HyperTree);
...
class HierarchyData {
  ...
  processStatify(data) {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_d3__["stratify"]
...
/* harmony default export */ __webpack_exports__["a"] = (HierarchyData);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = KeyboardNavigation;
...
const updateVisualisation = (file, content) => {
  ...
  (new __WEBPACK_IMPORTED_MODULE_1__utils_hierarchy_data__["a" /* default */](type))
    .load(content)
    .then(data => treemap(__WEBPACK_IMPORTED_MODULE_0_d3__["hierarchy"](data)))
    .then(root => {
      let tree; (tree = new __WEBPACK_IMPORTED_MODULE_2__hypertree_hypertree_js__["a" /* default */](root).build()).view.draw();
      new __WEBPACK_IMPORTED_MODULE_3__d3_visualizations_radial_tree_browser_js__["a" /* default */]('svg')
        .clear()
        .draw(tree.view);
    });
};
...
/* importer controls */
(new __WEBPACK_IMPORTED_MODULE_5__utils_import_controls_js__["a" /* default */]('.import-controls', updateVisualisation)).listen();
...
class HyperTreeAction {
  constructor(model) {
    ...
    this.start   = new __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_e__["a" /* default */]();
    this.end     = new __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_e__["a" /* default */]();
    this.current = new __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_e__["a" /* default */]();
  ...
  onDrag(node) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_debounce__["a" /* default */])(function() {
      if (!this.start.valid) {
...
/* harmony default export */ __webpack_exports__["a"] = (HyperTreeAction);
...
class HyperTreeDraw {
  constructor(model, view, size=1000) {
    ...
    this.sMax    = __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_s__["a" /* default */].fromCoord(size / 2, size / 2);
    this.sOrigin = __WEBPACK_IMPORTED_MODULE_0__hypertree_coord_s__["a" /* default */].fromCoord(this.sMax.x, this.sMax.y);

    this.drawNode = this.drawNode.bind(this);

    if (this.model.root.children) {
      this.root = new __WEBPACK_IMPORTED_MODULE_2__hypertree_draw_node_composite__["a" /* default */](this.model.root, this);
    } else {
      this.root = new __WEBPACK_IMPORTED_MODULE_1__hypertree_draw_node__["a" /* default */](this.model.root, this);
    }
  }
...
/* harmony default export */ __webpack_exports__["a"] = (HyperTreeDraw);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hypertree_draw_node__ = __webpack_require__(3);


/**
 * HyperTree draw node model wrapper for helper methods.
 **/
class HyperTreeDrawNodeComposite extends __WEBPACK_IMPORTED_MODULE_0__hypertree_draw_node__["a" /* default */] {
  get children() {
    if (!this.drawChildren) {
      this.drawChildren = this.node.children.map(node => {
        ...
        return new __WEBPACK_IMPORTED_MODULE_0__hypertree_draw_node__["a" /* default */](node, this.model);
      });
    }
...
/* harmony default export */ __webpack_exports__["a"] = (HyperTreeDrawNodeComposite);
...
class HyperTreeModel {
  constructor(node) {
    node = ((node.children || []).length === 0)
      ?  new __WEBPACK_IMPORTED_MODULE_0__hypertree_node__["a" /* default */](node, this)
      :  new __WEBPACK_IMPORTED_MODULE_1__hypertree_node_composite__["a" /* default */](node, this);
    this.node = node;
  }
...
/* harmony default export */ __webpack_exports__["a"] = (HyperTreeModel);
 ...
 **/
class HyperTreeNodeComposite extends __WEBPACK_IMPORTED_MODULE_0__hypertree_node__["a" /* default */] {
  constructor(node, model) {
    super(node, model);
    ...
    this.node.children = this.node.children.map(node => {
      ...
      return new __WEBPACK_IMPORTED_MODULE_0__hypertree_node__["a" /* default */](node, this.model);
    });
  }
...
/* harmony default export */ __webpack_exports__["a"] = (HyperTreeNodeComposite);
...
class HyperTreeView {
  constructor(model, options={}) {
    this.model    = model;
    this.renderer = new __WEBPACK_IMPORTED_MODULE_0__hypertree_draw__["a" /* default */](this.model, this);
    this._actions = new __WEBPACK_IMPORTED_MODULE_1__hypertree_action__["a" /* default */](this.renderer);
  }
...
/* harmony default export */ __webpack_exports__["a"] = (HyperTreeView);
